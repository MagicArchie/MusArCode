...
function setup() {
  ...
  if (selectedLanguage === 'gr') {
    titleText = "12. Δημαρχείο";
    video = createVideo(['../../../assets/videos/Video12_Gr.mp4']);
    mainFont = fontGr;
  } else {
    titleText = "12. Town Hall";
    video = createVideo(['../../../assets/videos/Video12_En.mp4']);
    mainFont = fontEn;
  }
...
function ContinuePressed() { 
  ...
  setTimeout(() => {
    localStorage.setItem("lastPage", "Video12");
