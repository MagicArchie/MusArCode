...
function setup() {
  ...
  if (selectedLanguage === 'gr') {
    titleText = "7. Μητρόπολη";
    video = createVideo(['../../../assets/videos/Video7_Gr.mp4']);
    mainFont = fontGr;
  } else {
    titleText = "7. Metropolitan Church";
    video = createVideo(['../../../assets/videos/Video7_En.mp4']);
    mainFont = fontEn;
  }
...
function ContinuePressed() {
  ...
  setTimeout(() => {
    localStorage.setItem("lastPage", "Video7");
