...
function setup() {
  ...
  if (selectedLanguage === 'gr') {
    titleText = "11. Καθεδρικός Ναός";
    video = createVideo(['../../../assets/videos/Video11_Gr.mp4']);
    mainFont = fontGr;
  } else {
    titleText = "11. Cathedral Church";
    video = createVideo(['../../../assets/videos/Video11_En.mp4']);
    mainFont = fontEn;
  }
...
function ContinuePressed() {
  ...
  setTimeout(() => {
    localStorage.setItem("lastPage", "Video11");
