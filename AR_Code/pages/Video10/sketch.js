...
function setup() {
  ...
  if (selectedLanguage === 'gr') {
    titleText = "10. Πλατεία Ανουντσιάτα";
    video = createVideo(['../../../assets/videos/Video10_Gr.mp4']);
    mainFont = fontGr;
  } else {
    titleText = "10. Annunziata Square";
    video = createVideo(['../../../assets/videos/Video10_En.mp4']);
    mainFont = fontEn;
  }
...
function ContinuePressed() {
  ...
  setTimeout(() => {
    localStorage.setItem("lastPage", "Video10");
