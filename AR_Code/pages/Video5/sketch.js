...
function setup() {
  ...
  if (selectedLanguage === 'gr') {
    titleText = "5. Ναός Άγιου Σπυρίδωνα";
    video = createVideo(['../../../assets/videos/Video5_Gr.mp4']);
    mainFont = fontGr;
  } else {
    titleText = "5. Church of Saint Spyridon";
    video = createVideo(['../../../assets/videos/Video5_En.mp4']);
    mainFont = fontEn;
  }
...
function ContinuePressed() {
  ...
  setTimeout(() => {
    localStorage.setItem("lastPage", "Video5");
