...
function setup() {
  ...
  if (selectedLanguage === 'gr') {
    titleText = "8. Νέο Φρούριο";
    video = createVideo(['../../../assets/videos/Video8_Gr.mp4']);
    mainFont = fontGr;
  } else {
    titleText = "8. New Fortress";
    video = createVideo(['../../../assets/videos/Video8_En.mp4']);
    mainFont = fontEn;
  }
...
function ContinuePressed() {
  ...
  setTimeout(() => {
    localStorage.setItem("lastPage", "Video8");
