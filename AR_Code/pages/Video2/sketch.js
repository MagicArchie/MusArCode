...
function setup() {
  ...
  if (selectedLanguage === 'gr') {
    titleText = "2. Άγαλμα Σχολεμβούργου";
    video = createVideo(['../../../assets/videos/Video2_Gr.mp4']);
    mainFont = fontGr;
  } else {
    titleText = "2. Schulenburg Statue";
    video = createVideo(['../../../assets/videos/Video2_En.mp4']);
    mainFont = fontEn;
  }
...
function ContinuePressed() {
  ...
  setTimeout(() => {
    localStorage.setItem("lastPage", "Video2");
