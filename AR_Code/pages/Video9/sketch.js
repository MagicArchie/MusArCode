...
function setup() {
  ...
  if (selectedLanguage === 'gr') {
    titleText = "9. Εβραϊκή Συναγωγή";
    video = createVideo(['../../../assets/videos/Video9_Gr.mp4']);
    mainFont = fontGr;
  } else {
    titleText = "9. Jewish Synagogue";
    video = createVideo(['../../../assets/videos/Video9_En.mp4']);
    mainFont = fontEn;
  }
...
function ContinuePressed() {
  ...
  setTimeout(() => {
    localStorage.setItem("lastPage", "Video9");
