...
function setup() {
  ...
  if (selectedLanguage === 'gr') {
    titleText = "6. Βενετσιάνικο πηγάδι";
    video = createVideo(['../../../assets/videos/Video6_Gr.mp4']);
    mainFont = fontGr;
  } else {
    titleText = "6. Venetian Well";
    video = createVideo(['../../../assets/videos/Video6_En.mp4']);
    mainFont = fontEn;
  }
...
function ContinuePressed() {
  ...
  setTimeout(() => {
    localStorage.setItem("lastPage", "Video6");
